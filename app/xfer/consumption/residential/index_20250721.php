    ...
    <div class="pagecontent mr_temp1">
      <div class="main_col"> 
        ...
        <h4>Features</h4>
			...
			<h3><a href="/consumption/residential/data/2020/index.php?view=consumption#estimates"><strong>Monthly Estimates Released for the 2020 Residential Energy Consumption Survey (RECS)</strong></a></h3>
