      ...
      <div class="main_col"> 
        ...
        <div class= "carousel blue_top">
          <ul id="slider1">
			    <!--Slider 1-->
			<li>
              <h1><a href="/consumption/residential/status/">2024 RECS data collection has started!</a></h1><br />
              <div class="carousel_image"><a href="/consumption/residential/status/" width="525"><img src="images/RECSsurveydatacollectionstart.svg" width="595"  alt="The 2024 Residential Energy Consumption Survey data collection has started! RTI International is collecting survey responses on behalf of the U.S. Energy Information Administration, the statistical and analytical agency within the U.S. Department of Energy. If you need additional information about the survey, please click here."/></a>
        ...
        <span class="left">
        <h4>Features</h4>
			<h3><a href="https://www.youtube.com/watch?v=Er4VRJRAWrM"><strong>Webinar</strong>: 2020 Residential Energy Consumption Survey Webinar - Estimating heating and other end uses</a></h3>
