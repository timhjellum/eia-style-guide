<?php
$pageTitle = "MECS Archive";
$locale = 'data';
$L2Title = "Manufacturying Energy Consumption Survey (MECS)";
...
<div id="outerX"> 
  ...
  <?php include ('global/includes/eia_header.inc') ; ?>
      ...
      <div class="pagecontent mr_temp2">
        <div class="main_col">
          <?php include ('consumption/manufacturing/includes/data_cycle_jump_menu.inc') ; ?>
          
          <h3>1991</h3>
          <ul>
            <li><a href="/consumption/manufacturing/data/previous/pdf/1991/1991.pdf" class="ico_pdf">Consumption of Energy for All Purposes (First Use)</a></li>
