		...
		<div class="l-col primary">
			...
			<div class="accordion">
				...
				<div class="accordion-content">
					...
					<div class="basic-table" id="table1">
						<table class="basic-table full-width">
							<caption> Table 1: Chemical Industries Received Slightly Higher Prices for their Products </caption>
							<thead>
								<tr>
							...
							<tfoot>
								<tr>
									<td colspan="99">Source: U.S. Bureau of Economic Analysis, Gross-Domestic-Product-(GDP)-by Industry Data, http://bea.gov/industry/gdpbyind_data.htm </td>
								</tr>
							</tfoot>
						</table>
					</div>
					...
					<div class="basic-table">
						<table class="basic-table full-width">
							<caption> Table 2: Chemical Industries Reduced Shipments </caption>
							<thead>
								<tr>
							...
							<tfoot>
								<tr>
									<td colspan="6">Sources: Federal Reserve Board, G.17: Industrial Production and Capacity Utilization, http://www.federalreserve.gov/releases/g17/; U.S. Bureau of Economic Analysis, Gross-Domestic-Product-(GDP)-by Industry Data, http://bea.gov/industry/gdpbyind_data.html </td>
								</tr>
							</tfoot>
						</table>
					</div>
				...
				<div class="accordion-content">
					...
					<div class="basic-table">
						<table class="basic-table full-width">
							<caption> Table 3: Chemical Industries Participated in Energy-Management Activities, 1998 and 2002 </caption>
							<thead>
								<tr>
							...
							<tfoot>
								<tr>
									<td colspan="4">* Significance testing was performed on the percentages in Table 3 to account for relative standard errors during data collection and determine those differences that are truly significant.<br /> Sources: Energy Information Administration, Manufacturing Energy Consumption Survey - Table 8.1: Number of Establishments by Participation in Energy-Management Activity, 1998, and 2002, http://www.eia.doe.gov/emeu/mecs/mecs2002/data02/shelltables.html </td>
								</tr>
							</tfoot>
						</table>
					</div>
					...
					<div class="basic-table">
						<table class="basic-table full-width">
							<caption> Table 4: Chemical Industries had Significant Capability to Switch Fuels, 2002 (Trillion Btu) </caption>
							<thead>
								<tr>
							...
							<tfoot>
								<tr>
									<td colspan="4">* The total electricity consumed amount does not include any electricity generated onsite.<br /> Sources: Energy Information Administration, Manufacturing Energy Consumption Survey &mdash; Tables 10.2, 10.4, 10.6, 10.8, 10.10, and 10.12: Capability to Switch Fuels to Alternative Energy Sources, 2002, http://www.eia.doe.gov/emeu/mecs/mecs2002/data02/shelltables.html </td>
								</tr>
							</tfoot>
						</table>
					</div>
...
<script src="js/chemical-highcharts.js"></script>
