  ...
  <?php include ('global/includes/eia_header.inc') ; ?>
      ...
      <div class="pagecontent mr_temp3"> 	
        ...
        <div class="main_col">
          ...
          <?php /*img src="img/image002.gif" width="566" height="346" alt="Figure 1" /*/ ?>
          ...
          <div class="fig1 tab_highchart"></div>
	        ...
	        <?php /*img src="img/image004.gif" width="473" height="193" alt="Figure 2" /*/ ?>
	        ...
	        <?php /*img src="img/image006.gif" width="557" height="280" alt="Figure 3" /*/ ?>
	        ...
	        <?php /*img src="img/image008.gif" width="495" height="267" alt="Figure 4" /*/ ?>
	        ...
	        <?php /*img src="img/image010.gif" width="516" height="289" alt="Figure 5" /*/ ?>
	        ...
	        <?php /*img src="img/image012.gif" width="566" height="347" alt="Figure 6" /*/ ?>
	        ...
	        <?php /*img src="img/image014.gif" width="564" height="319" alt="Figure 7" /*/ ?>
	        ...
	        <?php /*img src="img/image016.gif" width="515" height="343" alt="Figure 8" /*/ ?>
	        ...
	        <table width="100%" class="basic_table">
		        <caption>
			        Table 1: Plight of the Blast Furnace in Iron and Steel Mills, 1997 and 2002
		        </caption>
		        <thead>
			        <tr>
				        <th>&nbsp;</th>
	        ...
	        <table width="100%" class="basic_table">
		        <caption>
			        Table 2: Steel Energy Prices 1994-2002 (Dollars per Million Btu)
		        </caption>
		        <thead>
			        <tr>
				        <th>Year</th>
		        ...
		        <tfoot>
			        <tr>
				        <td colspan="6">Source: Energy Information Administration, Manufacturing Energy Consumption Survey - Table 7.2: Average Prices for Purchased Energy Sources, 1994, 1998, and 2002</td>
			        </tr>
		        </tfoot>
	        </table>
	        ...
	        <table width="100%" class="basic_table">
		        <caption>
			        Table 3: Steel Industry Received Relatively Lower Prices for their Products
		        </caption>
		        <thead>
			        <tr>
		        ...
		        <tfoot>
			        <tr>
				        <td colspan="6">Source: <a href="http://bea.gov/industry/gdpbyind_data.htm" target="_blank">U.S. Bureau of Economic Analysis, Gross-Domestic-Product-(GDP)-by Industry Data</a></td>
			        </tr>
		        </tfoot>
	        </table>
	        ...
	        <table width="100%" class="basic_table">
		        <caption>
			        Table 4: Steel Industry Reduced Shipments
		        </caption>
		        <thead>
			        <tr>
		        ...
		        <tfoot>
			        <tr>
				        <td colspan="6"><strong>Sources:</strong> <a href="http://www.federalreserve.gov/releases/g17/" target="_blank">Federal Reserve Board, G.17: Industrial Production and Capacity Utilization</a>; <a href="http://bea.gov/industry/gdpbyind_data.htm" target="_blank">U.S. Bureau of Economic Analysis, Gross-Domestic-Product-(GDP)-by Industry Data</a></td>
			        </tr>
		        </tfoot>
	        </table>
	        ...
	        <?php /*img src="img/image020.gif" width="536" height="243" alt="Figure 10" /*/ ?>
	        <a name="fig10chart" id="fig10chart"></a>
	        <div class="fig10 tab_highchart"></div>
	        <?php /*img src="img/image022.gif" width="565" height="230" alt="Figure 11" /*/ ?>
	        ...
	        <table width="100%" class="basic_table">
		        <caption>
			        Table 5: Steel Industry Participated in Energy-Management Activities, 1998 and 2002
		        </caption>
		        <thead>
			        <tr>
		        ...
		        <tbody>
			        ...
			        <tr>
				        <td colspan="4">Equipment Installation or Retrofit for the <u>Primary Purpose of Improving Energy Efficiency</u> Affecting:</td>
			        </tr>
			        <tr>
		        ...
		        <tfoot>
			        <tr>
				        <td colspan="4"><p><a name="significance"></a>* Significance testing was performed on the percentages in Table 5 to account for relative standard errors during data collection and determine those differences that are truly significant.</p>
					        <p>Sources: Energy Information Administration, Manufacturing Energy Consumption Survey - Table 8.1: Number of Establishments by Participation in Energy-Management Activity, 1998, and 2002</p></td>
			        </tr>
		        </tfoot>
	        </table>
	        <div id="footnotes">
...
<script src="js/steel-highcharts.js" type="text/javascript"></script>
</html>