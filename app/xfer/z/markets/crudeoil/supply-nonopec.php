...
<h1><?=$pageTitle?></h1>
			...
			<p>In 2024, countries outside of the&nbsp;<a href="https://www.eia.gov/tools/glossary/index.php?id=O#opec">Organization of the Petroleum  Exporting Countries (OPEC)</a>&nbsp;accounted  for 65% of global crude oil production, with the Americas, Russia,  and the North Sea as key production centers.</p> 
			<p>Non-OPEC crude supply has a direct impact on crude oil prices. When non-OPEC countries increase production, it generally lowers prices by increasing the total global supply. The opposite happens when they decrease production. However, the magnitude of this impact varies based on factors such as the scale of non-OPEC supply changes, global oil demand strength, OPEC’s response, and the cost of non-OPEC production. </p>
			<p>Unlike OPEC, where crude oil production is centrally coordinated, non-OPEC producers operate independently, making their own decisions about output. Also, while OPEC production is mainly controlled by national oil companies, international or investor-owned oil companies (IOCs) dominate production in non-OPEC countries. </p>
			<p>Driven primarily by the goal of increasing shareholder value, these IOCs base their investment decisions on economic factors and market conditions. Although some national oil companies may operate similarly, many have additional objectives tied to national interests, such as job creation, infrastructure development, or government revenue generation. As a result, investment in non-OPEC production, and therefore its potential to supply oil in the future, tends to be more responsive to shifts in market dynamics.</p>
			<p>Non-OPEC producers usually operate as price takers, reacting to market prices rather than attempting to influence prices by managing their production. This often leads them to produce at or near full capacity, resulting in limited spare capacity. Other things being equal, lower non-OPEC supply tends to push prices up by reducing total global supply of crude and increasing the "call on OPEC”, meaning how much crude the world needs OPEC to supply. The greater the call on OPEC, the more influence it has on prices. </p>
			<p><img src="images/Supply_nonOPEC_01.svg" alt="Tight market conditions –strong global oil demand growth coupled with low or falling oil production capacity– from 2003 to 2008 put upward pressure on oil prices"/></p>
...
"/></p>
		...
		<p>Oil prices are affected not only by current non-OPEC production but also by expectations about future non-OPEC supply. If traders and investors anticipate a significant increase in non-OPEC production, they may adjust their positions, leading to downward pressure on prices even before the increased supply materializes. </p>	
