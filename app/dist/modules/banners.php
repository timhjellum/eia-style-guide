...
<section id="bannersIntroduction">
	<div class="eia-container">
		<h1 class="uk-h1 tm-heading-fragment">Banners</h1>
		<p class="uk-text-lead">Information and system notifications and messaging.</p>
		<h4 class="uk-h3 tm-heading-fragment">Purpose</h4>
...
<section id="bannersAlert">
	<div class="eia-container">
		<h2 class="uk-h1 tm-heading-fragment">Alert</h2>
...
<section id="bannersCallout">
	<div class="eia-container">
		<h2 class="uk-h1 tm-heading-fragment">Callout</h2>
...
-->
	...
	<dt>Link color</dt>
	<dd>
		<div class="callout-banner-link-color" id="ColorExamples"></div>
	</dd>
</dl>
-->
		<!-- Example -->
...
<section id="bannersError">
	<div class="eia-container">
		<h2 class="uk-h1 tm-heading-fragment">Error</h2>
...
<h3 class="uk-heading-small">Color Check</h3>
	...
	<dt>Link color</dt>
	<dd>
		<div class="error-banner-link-color" id="ColorExamples"></div>
	</dd>
</dl>
-->
		<!-- Example -->
...
<section id="bannersInformation">
	<div class="eia-container">
		<h2 class="uk-h1 tm-heading-fragment">Information</h2>
...
<h3 class="uk-heading-small">Color Check</h3>
	...
	<dt>Link color</dt>
	<dd>
		<div class="information-banner-border-color" id="ColorExamples"></div>
	</dd>
</dl>
-->
		<!-- Example -->
...
<section id="bannersnotice">
	<div class="eia-container">
		<h2 class="uk-h1 tm-heading-fragment">Notice</h2>
...
<h3 class="uk-heading-small">Color Check</h3>
	...
	<dt>Link color</dt>
	<dd>
		<div class="notice-banner-link-color" id="ColorExamples"></div>
	</dd>
</dl>
-->
		<!-- Example -->
...
<section id="bannersSuccess">
	<div class="eia-container">
		<h2 class="uk-h1 tm-heading-fragment">Success</h2>
...
<h3 class="uk-heading-small">Color Check</h3>
	...
	<dt>Link color</dt>
	<dd>
		<div class="success-banner-link-color" id="ColorExamples"></div>
	</dd>
</dl>
-->
		<!-- Example -->
