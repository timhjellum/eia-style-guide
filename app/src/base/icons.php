...
<section id="fileTypes">
	<div id="FileTypes" class="fp-auto-height uk-child-width-1-4 uk-grid-small uk-margin-xlarge-bottom" uk-grid></div>
</section>
<section id="grid">
	<div id="Grid" class="fp-auto-height uk-child-width-1-4 uk-grid-small uk-margin-xlarge-bottom" uk-grid></div>
</section>
<section id="list">
	<div id="List" class="fp-auto-height uk-child-width-1-4 uk-grid-small uk-margin-xlarge-bottom" uk-grid></div>
</section>
<section id="menu">
	<div id="Menu" class="fp-auto-height uk-child-width-1-4 uk-grid-small uk-margin-xlarge-bottom" uk-grid></div>
</section>
<section id="social">
	<div id="Social" class="fp-auto-height uk-child-width-1-4 uk-grid-small uk-margin-xlarge-bottom" uk-grid></div>
</section>
<section>
