...
<section id="images">
	<div class="eia-container">
		<h2 class="uk-h1 tm-heading-fragment">Images</h2>
	...
	<ul class="ul _bullet">
		<li>Avoid link text like “Click Here,” “More,” and “Read More.” These kinds of links can be confusing when a screen reader reads them out of context.</div>
		<li>Use unique link text where possible. Speech recognition software users may have a bad experience with duplicated link text.</div>
