...
<main>
	...
	<section>
			...
			<div class="eia-card">
				<div class="l-margin-bottom eia-container-resizer">
					<div class="accessibility">
						...
						<p class="">Whenever a page presents images and other non-text content, it should present text alternatives. These text alternatives provide the same information presented by the image.</p>
						<p class="">
						...
						<p class="">Some other best practices include:</p>
						<ul class="ul bullet">
							...
							<li>
								<p class="">Provide color contrast and other design elements to help color blind users</p>
							</li>
						</ul>
						<p class="">To learn more about images, consider the following resources:</p>
						<ul class="ul bullet">
							<li>
						...
						<p class="">If an image does not have an alt attribute, a screen reader may announce the image&apos;s src attribute instead. So, all images must have an alt attribute. When an image does not have alt text, provide a null alt attribute, like so:</p>
						<pre>
	  <code>&lt;img alt ... /&gt;</code>
	</pre>
						<p class="">or</p>
	  ...
	  <code>&lt;img alt="" ... /&gt;</code>
						...
						<p class="">Images that have no function or information content whatsoever are decorative images. These images can include stock photos included just for “eye candy.” Such images should be hidden from assistive technologies.</p>
						<p class="">Decorative images can be hidden from screen readers in multiple ways:</p>
						<ul class="ul bullet">
							<li>
						...
						<div class="l-row full-width-col">
							...
							<div class="l-col">
								<p class="eia-para">Lorem ipsum dolor sit amet <a>consectetur adipiscing</a> elit.</p>
							</div>
						</div>
						...
						<div class="l-row full-width-col">
							...
							<div class="l-col">
								<p class="eia-para">Lorem ipsum dolor sit amet <a class="link">consectetur adipiscing</a> elit.</p>
							</div>
						</div>
						<div class="l-row full-width-col">
							<div class="l-col"><strong>Hover</strong></div>
							<div class="l-col">
								<p class="eia-para">Lorem ipsum dolor sit amet <a class="hover">consectetur adipiscing</a> elit.</p>
							</div>
						</div>
						<div class="l-row full-width-col">
							<div class="l-col"><strong>Focus</strong></div>
							<div class="l-col">
								<p class="eia-para">Lorem ipsum dolor sit amet <a class="focus">consectetur adipiscing</a> elit.</p>
							</div>
						</div>
					</div>
				</div>
				...
				<p class="">It&apos;s most important for link text to make sense without the surrounding sentences or content. The link text alone should convey the function and purpose of the link. Link text should also be unique and easy to speak out loud.</p>
				<p class="">Consider these guidelines when writing link text:</p>
				<ul class="ul _bullet">
					<li>Avoid link text like “Click Here,” “More,” and “Read More.” These kinds of links can be confusing when a screen reader reads them out of context.
			</div>
			<li>Use unique link text where possible. Speech recognition software users may have a bad experience with duplicated link text.
		</div>
		<li>It is OK to link a full sentence, but avoid longer.</div>
		<li>Use judgment when linking full URLs. When linking a URL, consider users who must speak it out loud and who must listen to a screen reader announce it.</div>
			</ul>

			<p class="">
				<strong>Fallbacks</strong>
			</p>
			<p class="">Occasionally, it may not be possible to make link text alone convey the link&apos;s purpose out of context. In those cases, a few fallback strategies are available:</p>
			<ul class="ul _bullet">
				<li>The link together with the surrounding sentence, paragraph, or list item should be enough to convey a link&apos;s meaning or purpose.</div>
				<li>You may give more context through the link&apos;s title attribute.</div>
				<li>These approaches create a worse experience for users with disabilities, so they should a last resort.</div>
			</ul>
			<p class="">https://usability.yale.edu/web-Accessibilityarticles/links</p>
