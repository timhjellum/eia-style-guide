	...
	<table class="uk-table uk-table-divider">
		...
		<tbody>
			<tr>
				...
				<td>Adds top margin, if it is preceded by another element, and always bottom margin.</td>
			</tr>
			<tr>
			...
			<table class="uk-table uk-table-divider">
				...
				<tbody>
					<tr>
						...
						<td>Adds small top margin, if it is preceded by another element, and always bottom margin.</td>
					</tr>
					<tr>
			...
			<table class="uk-table uk-table-divider">
				...
				<tbody>
					<tr>
						...
						<td>Adds medium top margin, if it is preceded by another element, and always bottom margin.</td>
					</tr>
					<tr>
			...
			<table class="uk-table uk-table-divider">
				...
				<tbody>
					<tr>
						...
						<td>Adds large margin, if it is preceded by another element, and always bottom margin.</td>
					</tr>
					<tr>
			...
			<table class="uk-table uk-table-divider">
				...
				<tbody>
					<tr>
						...
						<td>Adds larger margin, if it is preceded by another element, and always bottom margin.</td>
					</tr>
					<tr>
			...
			<div class="eia-container">
				...
				<div class="uk-overflow-auto">
					<table class="uk-table uk-table-divider">
						...
						<tbody>
							<tr>
								<td><code>.margin-remove-left@s</code><br> <code>.margin-remove-right@s</code></td>
								<td>Affects device widths of <em>640px</em> and larger.</td>
							</tr>
							<tr>
								<td><code>.margin-remove-left@m</code><br> <code>.margin-remove-right@m</code></td>
								<td>Affects device widths of <em>960px</em> and larger.</td>
							</tr>
							<tr>
								<td><code>.margin-remove-left@l</code><br> <code>.margin-remove-right@l</code></td>
								<td>Affects device widths of <em>1200px</em> and larger.</td>
							</tr>
							<tr>
								<td><code>.margin-remove-left@xl</code><br> <code>.margin-remove-right@xl</code></td>
		...
		<section id="dilly">
			<div class="eia-container">
					...
					<table class="uk-table uk-table-divider">
						...
						<tbody>
							<tr>
								...
								<td>Sets left and right margin to auto, horizontally centering block and flex elements.</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>Sets top and bottom margin to auto, vertically centering only flex elements.</td>
							</tr>
						</tbody>
					</table>
				</div>
				...
				<ul class="margin">
					...
					<li>
						<pre><code id="code-example-197"></code></pre>
					</li>
				</ul>
	...
	<div class="eia-container">
		...
		<div class="uk-overflow-auto">
			<table class="uk-table uk-table-divider">
				...
				<tbody>
					<tr>
						<td><code>.margin-auto-left@s</code><br> <code>.margin-auto@s</code><br> <code>.margin-auto-right@s</code></td>
						<td>Affects device widths of <em>640px</em> and larger.</td>
					</tr>
					<tr>
						<td><code>.margin-auto-left@m</code><br> <code>.margin-auto@m</code><br> <code>.margin-auto-right@m</code></td>
						<td>Affects device widths of <em>960px</em> and larger.</td>
					</tr>
					<tr>
						<td><code>.margin-auto-left@l</code><br> <code>.margin-auto@l</code><br> <code>.margin-auto-right@l</code></td>
						<td>Affects device widths of <em>1200px</em> and larger.</td>
					</tr>
					<tr>
						<td><code>.margin-auto-left@xl</code><br> <code>.margin-auto@xl</code><br> <code>.margin-auto-right@xl</code></td>
						<td>Affects device widths of <em>1600px</em> and larger.</td>
					</tr>
				</tbody>
			</table>
...
<section id="dilly">
	<div class="eia-container">
		...
		<ul class="margin">
			...
			<li>
				<pre><code id="code-example-199"></code></pre>
			</li>
		</ul>
	</div>
	</div>
			...
			<div uk-sticky="offset: 160" class="uk-sticky uk-active uk-sticky-fixed" style="position: fixed; width: 200px; margin-top: 0px !important; top: 160px;">
				<ul class="uk-nav uk-nav-default tm-nav" uk-scrollspy-nav="closest: li; scroll: true; offset: 100">
					...
					<li><a href="../assets/uikit/tests/margin.html" target="_blank" rel="noreferrer"><span class="margin-small-right uk-icon" uk-icon="push"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
							...
							<span class="uk-text-middle">Open test</span></a></li>
					<li><a href="https://github.com/uikit/uikit/issues" target="_blank" rel="noreferrer"><span class="margin-small-right uk-icon" uk-icon="warning"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
							...
							<span class="uk-text-middle">Report issue</span></a></li>
					<li><a href="https://discordapp.com/invite/NEt4Pv7" target="_blank" rel="noreferrer"><span class="margin-small-right uk-icon" uk-icon="commenting"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
							...
							<span class="uk-text-middle">Get help</span></a></li>
					<li><a href="https://github.com/uikit/uikit-site/tree/develop/docs/pages/margin.md" target="_blank" rel="noreferrer"><span class="margin-small-right uk-icon" uk-icon="pencil"><svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
