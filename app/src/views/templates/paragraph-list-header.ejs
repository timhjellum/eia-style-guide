<h2 id="xoxoxo" class="uk-h3 tm-heading-fragment">xoxoxo</h2>
...
<pre><code class="language-html" id="xoxoxo"></code></pre>
<!-- Copy Button -->
<p>
	<button class="copy-element uk-button uk-button-primary" data-clipboard-action="copy" data-clipboard-target="#xoxoxo">
...
<div class="uk-margin-medium">
	...
	<pre><code class="language-html" id="LinksLinkLabelAria"></code></pre>
	<!-- Copy Button -->
	<p>
		<button class="copy-element uk-button uk-button-primary" data-clipboard-action="copy" data-clipboard-target="#LinksLinkLabelAria">
			<span uk-icon="copy"></span>Copy to clipboard
		</button>
	</p>
