document.write(`<h3 id="two-col-even" class="uk-h3 tm-heading-fragment">Two Columns Even (50%<div class="pipe">/</div>50%)</h3>
...
<pre><code class="language-html" id="l-two-col-even">&lt;div class="l-row l-two-col-even"&gt;
  &lt;div class="l-col"&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit.&lt;/div&gt;
  &lt;div class="l-col"&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit.&lt;/div&gt;
&lt;/div&gt;</code></pre>
<p>
	<button class="copy-element uk-button uk-button-primary" data-clipboard-action="copy" data-clipboard-target="#l-two-col-even">
