		...
		<section id="top">
			...
			<div class="grid-wrapper">
				...
				<section id="introduction">
					<div class="wrapper">
						<h1 class="header" id=" FancyApps (Modals)">FancyApps (Modals)</h1>
						<p class="para"></p>
					</div>
				</section>
				<!-- $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$ -->
				...
				<section id="Enlarge Image">
					<div class="wrapper">
						<h3 class="header">Enlarge Image</h3>
						<div class="uk-text-default uk-text-normal uk-text-uppercase">Live Example</div>enlarge-
...
&lt;!-- &lt;/div&gt; --&gt;</code></pre>
				...
				<section id="enlargeImageCaption">
					<div class="wrapper">
						<h3 class="header">Enlarge Image With Caption</h3>
...
&lt;/a&gt;</code></pre>
				...
				<section id="clickToEnlargeImage">
					<div class="wrapper">
						<h3 class="header">Enlarge Image With Caption and "Click to enlarge" instruction</h3>
						<div class="uk-text-default uk-text-normal uk-text-uppercase">Live Example</div>
						<dl class="uk-description-list uk-description-list-divider">
							<dd></dd>
						</dl>
...
&lt;/div&gt;</code></pre>
				...
				<section id="openIFrameInModal">
					<div class="wrapper">
						<h3 class="header">Open iFrame in Modal</h3>
						<div class="uk-text-default uk-text-normal uk-text-uppercase">Live Example</div>
						<dl class="uk-description-list uk-description-list-divider">
							...
							<div class="secondary-alt">
								<ul class="list-items">
									<li class="head api-icon">
										...
										<h2 class="header">Application Programming Interface (API)</h2>
									</li>
